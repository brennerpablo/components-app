...
import { TableProperties, ArrowUpRight, BarChart2 } from "lucide-react";
    ...
    components: [
      {
        title: "Heatmap",
        description:
          "A GitHub-style activity heatmap showing 52 weeks of data with color-coded intensity levels, hover tooltips, and four color schemes.",
        href: "/heatmap",
        icon: BarChart2,
        tags: ["Heatmap", "date-fns", "Dark Mode"],
      },
    ],
  },
];
